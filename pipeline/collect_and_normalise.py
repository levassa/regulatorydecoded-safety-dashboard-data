...
def normalise_safety_gate(df: pd.DataFrame) -> pd.DataFrame:
    ...
    for _, r in df.iterrows():
        ...
        rows.append({
            ...
            "region":            "EU / EEA",
            "notifying_country": str(r.get("alert_country", r.get("notifying_country", ""))).strip(),
            "country_of_origin": str(r.get("product_country", r.get("country_of_origin", ""))).strip(),
            "product_category":  normalise_category(str(r.get("product_category", r.get("product_type", "")))),
            "product_desc":      str(r.get("product_description", r.get("product_name", r.get("title", "")))).strip(),
